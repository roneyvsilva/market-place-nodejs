...
const { validaPedido, validaIdParams, validaProdutoFK } = require("../middleware/validacao.middleware");
...
// rotas POST
router.post("/create", authMiddleware, validaProdutoFK, validaPedido, pedidoController.createPedidoController);
//rotas DELETE
